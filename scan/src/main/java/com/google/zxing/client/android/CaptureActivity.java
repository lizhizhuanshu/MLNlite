        ...
        if (intent != null) {
            ...
            if (Intents.Scan.ACTION.equals(action)) {
                ...
                if (customPromptMessage != null) {
                    viewfinderView.setNoticeText(customPromptMessage);
                }
...
//			handleDecodeExternally(rawResult, resultHandler, barcode);
    ...
    private void handleDecodeInternally(Result rawResult, ResultHandler resultHandler, Bitmap barcode) {
        OuterResultHandler.handleDecodeInternally(this, rawResult, resultHandler, barcode);
    }
    ...
    private void handleDecodeExternally(Result rawResult,
        ...
        if (resultDurationMS > 0) {
            ...
            viewfinderView.setNoticeText(String.format("%s : %s",
    ...
    private void resetStatusView() {
        ...
        viewfinderView.setNoticeText((String) getResources().getText(R.string.msg_default_status));
