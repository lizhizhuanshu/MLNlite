 ...
 * Label 不能切割圆角,文字会不显示
 */
//lizhi TextView To AppCompatTextView
public class BorderRadiusTextView extends AppCompatTextView implements IBorderRadiusView, IClipRadius, ViewClipHelper.SuperDrawAction {
