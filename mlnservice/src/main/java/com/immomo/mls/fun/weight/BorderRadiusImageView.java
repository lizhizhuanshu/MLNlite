...
//lizhi ImageView To AppCompatImageView
public class BorderRadiusImageView extends AppCompatImageView implements IBorderRadiusView, IClipRadius, ViewClipHelper.SuperDrawAction {
...
//        backgroundDrawable.setDrawRadiusBackground(draw);
    ...
    public void forceClipLevel(int clipLevel) {
        viewClipHelper.setForceClipLevel(LEVEL_FORCE_CLIP);//ImageView 需要强制切割图片，统一效果
    }
